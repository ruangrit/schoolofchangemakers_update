...
$data_select = array();
 $sql = "select * from knowledge where author_id in(25,26,33,48,383,384,398,527,533,534,601,818,904,1071,1141,565,28,1174,540) order by id ASC ";
 //$sql = "select * from activity where type ='Activity' || type='Volunteer' limit0,50 order by id";
 //$sql = "select * from knowledge where id=426";
