...
<div class="<?php print $classes; ?>">
  ...
  <?php if ($header): ?>
    <div class="view-header" style="border:1px solid #333333!important;">
      <?php print $header; ?>
    </div>
  <?php endif; ?>
  <?php if ($exposed): ?>
...
<h2 class="headline headline__alte">KNOWLEDGE <!--: <span class="headline__small">All Interests</span>--></h2>
</div>
