		...
		<?php if(isset($user->roles[3]) || isset($user->roles[5])): ?>
			<div class=" topic--row row">
				...
				<div class=" author col-xs-3"> 
					...
					<div class="display">
						<?php if(!empty($user_post->picture->filename)){
					 		print '<img src="/sites/default/files/pictures/'.$user_post->picture->filename.'">';
					 	}else{
					...
					<div class="col-xs-8 pad0">
						...
						<a href="/user/<?php print $user_post->uid; ?>">
							<div class="text-name-community linelimit__1">						
								<?php print changemakers_get_contact($user_post->uid); //$user->field_profile_firstname['und'][0]['value'];?>								
							</div>
						</a>
