...
<script type="text/javascript">
    ...
    <ul class="list-inline nav--second" >
        ...
        <div class="nav2--content--manage"></div>
       ...
       <!--  <li>
        ...
        <div class="nav2--journal--coach"></div>
        <div class="nav2--name">Coach Journal</div>
        </a>
        </li>
        
         <li>
        <a href="/coach-community/list" class="nav2--list">
        <div class="nav2--commu--coach"></div>
        ...
        <a href="/my-projects" class="nav2--list">
        <div class="nav2--myproject"></div>
        <div class="nav2--name">Coach Project</div>
        </a>
        </li>
        <li>     
        <a href="/dashboard" class="nav2--list">
       ...
       <!--  <li>
        ...
        <div class="nav2--project--update"></div>
        <div class="nav2--name">Update Project</div>
        </a>
        </li> 
        <?php endif; ?>
        ...
        <div class="nav2--campaign--add"></div>
    ...
    <li><a href="/user/" class="">
        ...
        if($user->roles[10]){
            print '<i class="icon-profile txtgray2"></i>';
        }else if($user->roles[4] || $user->roles[3]){
            print '<i class="icon-profile-verify"></i>';
        }else if($user->roles[5]){
            print '<i class="icon-user-pair txtgray2"></i>';
        }else if($user->roles[6]){
            print '<i class=" icon-commerical-building txt__gray2"></i>';
        }else if($user->roles[8]){
            print '<i class="icon-headphones txtgray2"></i>';
        }else if($user->roles[9]){
            print '<i class="icon-briefcase txtgray2"></i>';
        }
         ?> Profile
    </a></li>
    ...
    -->
            <?php }else{ ?>
              <ul class="list-inline" id="index--link__gray">
                  <li class="leaf"><i class="icon-profile"></i> <a href="/user/register" class="">Register</a></li>
                <li class="leaf"><i class="icon-lock"></i> <a href="" data-toggle="modal" data-target="#myLogin" class="">Log in</a></li>
              </ul>
            <?php } ?>
              ...
              <?php if (!empty($primary_nav) || !empty($secondary_nav) || !empty($page['navigation'])): ?>
                ...
                <div class="search-top form col-xs-3 col-xs-offset-1 text-right">
                    <form method="get" id="search" enctype="multipart/form-data" action="/search"  accept-charset="UTF-8" >
                      <div class="input-group clear"  style="padding-top:5px;">
...
<div class="col-xs-12  participate--box ">
    ...
    <div class="col-xs-12 ">
        <div class="row">
        <div class="col-xs-3" >
        <a href="/participate-take-a-class" class="para--link">
        <div class="row">
        ...
        <a href="/participate-take-a-class" class="participate--btn">Learn more <span class="glyphicon glyphicon-play-circle"></span></a>
        </div></div>
        </a>
        </div>

        <div class="col-xs-3">
        <a href="/participate-change-starts-here" class="para--link">
        <div class="row">    
        ...
        <a href="/participate-change-starts-here" class="participate--btn">Learn more <span class="glyphicon glyphicon-play-circle"></span></a>
        </div></div>
        </a>
        </div>

        <div class="col-xs-3">
        <a href="/participate-become-a-coach" class="para--link">
        <div class="row">
        ...
        <a href="/participate-become-a-coach" class="participate--btn">Learn more <span class="glyphicon glyphicon-play-circle"></span></a>
        </div></div>
        </a>
        </div>

        <div class="col-xs-3">
        <a href="/participate-invest-in-changemakers" class="para--link">
        <div class="row">
        ...
        <a href="/participate-invest-in-changemakers" class="participate--btn">Learn more <span class="glyphicon glyphicon-play-circle"></span></a>
            </div></div>
        </a>
        </div>
    </div></div>
...
<footer class="footer--box  col-xs-12" >
        ...
        <p class="col-xs-12 row">@2015 Ashoka - School of Changemakers | <a href="/termofuse">Term of Use</a></p>
        </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              //action="/changemakers/check_login"
                    ?>
              <form method="post" id="user-login-modal" enctype="multipart/form-data" action="/user/login"   accept-charset="UTF-8" >
              <!-- <form enctype="multipart/form-data" action="/changemakers/update-profile" onsubmit="return check_user_login()" method="post" id="user-profile-form" accept-charset="UTF-8"> -->
                <div>
                  ...
                  <div class="form-actions form-wrapper form-group" id="edit-actions">
                     <button type="submit" id="edit-submit-login" name="op" value="Log in"   class="btn btn--submit">Log in</button>
                  </div>
        ...
        <div class="modal-dialog modal-dialog-center">
          <div class="modal-content">
            ...
            <div class="alert alert-danger error-massage"></div>
             <div class="alert alert-success success-massage"></div>
              <?php //$elements_pass = drupal_get_form("user_pass"); 
                // print "<pre>";
                // print_r($elements_pass);
                // print "</pre>";
              ?>
              <form method="post" id="user-forget-pass-modal" enctype="multipart/form-data" action="/user/password"  accept-charset="UTF-8" >
                <div>
                  <div class="form-item form-item-name form-type-textfield form-group"> 
                  ...
                  <div class="form-actions form-wrapper form-group" id="edit-actions">
                    ...
                    <button type="submit"  id="edit-submit-forgot-password" name="op" value="E-mail new password" class="btn btn--submit">Request new password</button>
                  </div>
                </div>
             </form>
