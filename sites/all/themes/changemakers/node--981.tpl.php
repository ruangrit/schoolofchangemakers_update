...
if(!empty($select_project)){
	...
	?>
	<div>
		<p><h2>เลือกโปรเจกต์ที่ต้องการอัพเดต</h2></p>
...
<?php 		
	...
	if($user->roles[10] || $user->roles[4]){ ?>
	 <div>คุณยังไม่มีโปรเจกต์ สามารถสร้างโปรเจกต์ได้ที่นี่ <a href="/node/add/project">สร้างโปรเจกต์</a></div>
<?php 
}
else{ ?>
	<div>คุณยังไม่มีโปรเจกต์ใดๆ ที่สามารถอัพเดตได้</div>
<?php }
}		
?>
