...
?>
<div class="col-xs-12 pagebigtab online--bigtab">
	<div class="thumb field-name-field-course-image ">
    ...
    <h2 class="headline__thaisan pagebigtab--name clear col-xs-8"><?php  print $node->title; ?></h2>
        ...
        <div class="col-xs-4 txt__right pad0"><a href="/online-course"><button class="btn--border"><i class=" icon-left-big"></i> ย้อนกลับสู่รายการคอร์ส</button></a></div>
    </div>   
...
<div class="row margin__top20">
		...
		<div class="row">
            <div class="pagebigtab--detail--box detail--icon--for">
                    <div class="pagebigtab--detail-topic">สำหรับ</div>
                    <div class="pagebigtab--detail-txt tag--linelimit__1"><?php echo $node->field_for_course['und'][0]['taxonomy_term']->name; ?></div>
            </div>
            
            <div class="pagebigtab--detail--box detail--icon--skill">
                    <div class="pagebigtab--detail-topic">ทักษะ</div>
                    <div class="pagebigtab--detail-txt tag--linelimit__1">
			...
			<div class="pagebigtab--detail--box detail--icon--problem">
        ...
        <div class="col-xs-12 padding-header ">
            ...
            <a href="<?php echo $worksheet; ?>" traget="_blank"><button class="btn btn--submit col-xs-12"><i class="icon-file-pdf"></i> Download Worksheet</button></a>
            <?php endif; ?>
		</div>
...
<div class="margin-top-header col-xs-12 pad0">
  	<!-- Nav tabs -->
    	...
    	<div role="tabpanel" class="tab-pane active" id="introduction">
      	...
      	<div class="row"> 
            ...
            <div class="course--name">
                <h3 class="headline headline__thaisan"><a href="#" id="cmk"><i class=" icon-book txt__18"></i> In this Course you will</a></h3>
                </div>
               ...
               <div class="col2--sidebar bg__white">
                  ...
                  <!--<ul class="nav nav-tabs tabs-left course--lesson">-->
                    <ul class="course--lesson">
                       <div class="course--name"><h3 class="headline headline__thaisan"> <i class=" icon-book txt__18"></i> <a href="#" id="coach" ><?php  print $node->title; ?></a></h3></div>
                    
                    <?php 
                    $i=1;
                    foreach ($lession_course as $key => $value) {
                        if($value['count']==0){
                            echo "<li class='lesson--row active'><a href='#$value[nid]' data-toggle='tab'>$i. $value[title]</a></li>";
                        }else{
                             echo "<li class='lesson--row'><a href='#$value[nid]' data-toggle='tab'>$i. $value[title]</a></li>";
                        }
                        $i++;
                    }
                    ?>
                ...
                <div class="col2--viewcontent pagebigtab--bg">
                    <!-- Tab panes -->
                    <div class="tab-content online-course-content">
                         <?php 
                    foreach ($lession_course as $key => $value) {
                        if($value['count']==0){
                             echo "<div class='tab-pane active' id='$value[nid]'>$value[body]</div>";
                        }else{
                             echo "<div class='tab-pane' id='$value[nid]'>$value[body]</div>";
                        }
                    }
                    ?>
                    </div>
