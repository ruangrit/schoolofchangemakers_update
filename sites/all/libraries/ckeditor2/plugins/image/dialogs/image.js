...
(function() {
    var v = function(d, l) {
        ...
        return {
            ...
            onLoad: function() { "image" != l && this.hidePage("Link");
            ...
            contents: [{
                ...
                elements: [{
                    ...
                    children: [{
                        ...
                        }, { type: "button", id: "browse", style: "display:none;margin-top:14px;", align: "center", label: d.lang.common.browseServer, hidden: 0, filebrowser: "info:txtUrl" }]
                    }]
                }, {
                    id: "txtAlt",
                    type: "text",
                    ...
                    commit: function(a, b) { 1 == a ? (this.getValue() || this.isChanged()) && b.setAttribute("alt", this.getValue()) : 4 == a ? b.setAttribute("alt", this.getValue()) : 8 == a && b.removeAttribute("alt") }
                }, {
                    type: "hbox",
                    children: [{
                        id: "basic",
                        ...
                        children: [{
                            ...
                            children: [{
                                ...
                                onLoad: function() {
                                    ...
                                    b && (b.on("click", function(a) { n(this);
                                            ...
                                            a.data && a.data.preventDefault() }, this.getDialog()),
                ...
                }, { type: "button", id: "browse", filebrowser: { action: "Browse", target: "Link:txtUrl", url: d.config.filebrowserImageBrowseLinkUrl }, style: "display:none", hidden: 0, label: d.lang.common.browseServer }, {
                    id: "cmbTarget",
                    type: "select",
