...
(function() {
                ...
                domReady: function() {
                    ...
                    return function(b) {
                        ...
                        if (1 == c.length)
                            ...
                            b = !1;
                            try { b = !window.frameElement } catch (v) {}
    ...
    CKEDITOR.event || (CKEDITOR.event = function() {}, CKEDITOR.event.implementOn = function(a) {
        ...
        return {
            ...
            on: function(b, d, g, k, l) {
                function q(a, f, y, l) { a = { name: b, sender: this, editor: a, data: f, listenerData: k, stop: y, cancel: l, removeListener: v };
                    return !1 === d.call(g, a) ? !1 : a.data }

                function v() { y.removeListener(b, d) }
                var f = a.call(this, b);
                if (0 > f.getListenerIndex(d)) { f = f.listeners;
                    ...
                    for (var A = f.length - 1; 0 <= A; A--)
                        if (f[A].priority <= l) return f.splice(A + 1, 0, q), { removeListener: v };
                    f.unshift(q) }
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            getDocumentPosition: function(a) {
                ...
                if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
                    ...
                    k && (CKEDITOR.env.webkit || CKEDITOR.env.ie && 12 <= CKEDITOR.env.version ? (b = d.$.scrollLeft || g.scrollLeft, c = d.$.scrollTop || g.scrollTop) : (c = e ? d.$ : g, b = c.scrollLeft, c = c.scrollTop), b = r.left + b - w, c = r.top + c - n) } else
                    for (n = this, w = null; n && "body" != n.getName() &&
                        "html" != n.getName();) { b += n.$.offsetLeft - n.$.scrollLeft;
            ...
            getFrameDocument: function() {
                var a = this.$;
                try { a.contentWindow.document } catch (b) {
                    a.src =
                        a.src
                }
            ...
            copyAttributes: function(a, b) {
                ...
                for (var f = 0; f < c.length; f++) {
                    ...
                    if (!(e in b))
                        ...
                        else if (!CKEDITOR.env.ie || this.hasAttribute(e)) r = this.getAttribute(e), null === r && (r = d.nodeValue), a.setAttribute(e, r) } "" !== this.$.style.cssText && (a.$.style.cssText = this.$.style.cssText) },
    ...
    (function() {
        ...
        function d(a, b, c, d, e) {
            ...
            if (h && m.type == CKEDITOR.NODE_TEXT && p.equals(m)) p = a.document.createText(p.substring(x, z)), c.append(p);
                ...
                for (Q = I; Q <= K; Q++)
                    ...
                    else { Q != K || c.equals(N[Q]) && K < G ? b && (L = J.append(c.clone(0, e))) : B ? n(c, J, !1, v) : O && J.append(a.document.createText(c.substring(0, z)));
                        if (Q > fa)
                            for (; U;) U = n(U, J, !0);
                        J = L }
                h || k()
        ...
        function e(a) {
            return function() {
                var b;
                return this[a ?
                    "getPreviousNode" : "getNextNode"](function(a) {!b && v(a) && (b = a);
            ...
            enlarge: function(a, b) {
                ...
                switch (a) {
                                        ...
                                        if (x && CKEDITOR.dtd.$removeEmpty[p.getName()]) {
                                            ...
                                            if (d.test(F)) p = null;
                                                ...
                                                for (var B = p.$.getElementsByTagName("*"), E = 0, v; v =
                                                    B[E++];)
                                                    if (!CKEDITOR.dtd.$removeEmpty[v.nodeName.toLowerCase()]) { p = null;
                                                        break }
                                            p && (z = !!F.length)
                                        } else p = null;
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var q, O, N = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? { br: 1 } : null),
                            C = null,
                            I = function(a) {
    ...
    (function() {
        ...
        function b(a, c, e, g) {
            ...
            if ((k = CKEDITOR.filter.instances[g.element.data("cke-filter")]) && !k.check(c)) return b(a,
                c, e, g.remaining);c = new CKEDITOR.dom.range(g.element);c.selectNodeContents(g.element);c = c.createIterator();c.enlargeBr = a.enlargeBr;c.enforceRealBlocks = a.enforceRealBlocks;c.activeFilter = c.filter = k;a._.nestedEditable = { element: g.element, container: e, remaining: g.remaining, iterator: c };
            return 1
        }
                ...
                for (this._.nextNode = null; w;) {
                    ...
                    if (t) w.type == CKEDITOR.NODE_TEXT && e.test(w.getText()) && (t = 0);
                        ...
                        if (CKEDITOR.dtd.$block[p] && "false" == w.getAttribute("contenteditable")) { d = w;
                            b(this, a, d);
                            break } else if (w.isBlockBoundary(this.forceBrBreak && !u && { br: 1 })) {
                            if ("br" == p) t = 1;
                    ...
                    A = (!H || t) && w.equals(n);
                    if (k && !H)
                        for (; !w.getNext(l) && !A;) { p = w.getParent();
                            if (p.isBlockBoundary(this.forceBrBreak && !u && { br: 1 })) { H = 1;
                                t = 0;
                                A || p.equals(n);
    ...
    (function() {
        ...
        function f(a) {
            var b, c, d, h, p = {},
                e = 1;
            for (a = Y(a); b = a.match(C);)(c = b[2]) ? (d = y(c, "styles"), h = y(c, "attrs"), c = y(c, "classes")) : d = h = c = null, p["$" + e++] = { elements: b[1], classes: c, styles: d, attributes: h }, a = a.slice(b[0].length);
            return p }
        ...
        function r(a, b, h, e) {
            ...
            if (e.doCallbacks && a.elementCallbacks) { a: { f = a.elementCallbacks;
                    ...
                    f = void 0 }
                if (f) return f }
            if (e.doTransform && (f = a._.transformations[b.name])) { A(b);
            ...
            if (e.doFilter) {
                a: {
                    ...
                    x = e.skipRequired;
                    var F = { valid: !1, validAttributes: {}, validClasses: {}, validStyles: {}, allAttributes: !1, allClasses: !1, allStyles: !1, hadInvalidAttribute: !1, hadInvalidClass: !1, hadInvalidStyle: !1 },
                        k, C;
                    if (a || f) { A(b);
                        if (g)
                            for (k = 0, C = g.length; k < C; ++k)
                                if (!1 === c(g[k], b, F)) { a = null;
                                    break a }
                        if (t)
                ...
                if (!a.allStyles || a.hadInvalidStyle) {
                    ...
                    E.length && (g.style = E.sort().join("; ")) } else J && (g.style = J);
                if (!a.allClasses ||
                    a.hadInvalidClass) {
                    for (B = 0; B < t.length; ++B)(a.allClasses || f[t[B]]) && F.push(t[B]);
                    F.length && (g["class"] = F.sort().join(" "));
                    x && F.length < x.split(/\s+/).length && (k = !0) } else x && (g["class"] = x);k && (m = 1);
        ...
        function h(a, b, c) {
            var d = a.name;
            if (B.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(u()) : (a.parent && c.push({ check: "it", el: a.parent }), a.remove());
            ...
            for (p in d)
                if ("class" == p)
                    for (c = d[p].split(/\s+/), m = a.classes.join("|"); f = c.pop();) {
                        if (-1 == m.indexOf(f)) return !1 } else if (a.attributes[p] != d[p]) return !1;
            for (e in h)
                if (a.styles[e] !=
                    h[e]) return !1;
            return !0
        ...
        CKEDITOR.filter.prototype = {
            ...
            applyTo: function(a, b, c, d) {
                ...
                var p = this,
                    ...
                    f, g = !1,
                    n = { doFilter: !c, doTransform: !0, doCallbacks: !0, toHtml: b };
                a.forEach(function(a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        if ("off" == a.attributes["data-cke-filter"]) return !1;
                        if (!b || "span" != a.name || !~CKEDITOR.tools.objectKeys(a.attributes).join("|").indexOf("data-cke-"))
                            if (f = r(p, a, e, n), f & 1) g = !0;
                            else if (f & 2) return !1 } else if (a.type == CKEDITOR.NODE_COMMENT && a.value.match(/^\{cke_protected\}(?!\{C\})/)) {
                        var c;
                        a: {
                ...
                if (!this.disabled && a) {
                    ...
                    for (h = 0; h < a.length; ++h) {
                        ...
                        for (e = 0; e < b.length; ++e) m = b[e], "string" == typeof m ? (m = m.split(/\s*:\s*/), f = m[0], g = null, t = m[1]) : (f = m.check, g = m.left, t = m.right), p || (p = m, p = p.element ? p.element : f ? f.match(/^([a-z0-9]+)/i)[0] :
                            p.left.getDefinition().element), g instanceof CKEDITOR.style && (g = z(g)), c.push({ check: f == p ? null : f, left: g, right: "string" == typeof t ? F(t) : t });
                        b = p;
                        d[b] || (d[b] = []);
                        d[b].push(c)
                    }
            ...
            check: function(a, b, c) {
                ...
                if ("string" == typeof a) {
                    ...
                    h = d
                } else d = a.getDefinition(), h = d.styles, m = d.attributes || {}, h && !CKEDITOR.tools.isEmpty(h) ? (h = E(h), m.style = CKEDITOR.tools.writeCssText(h, !0)) : h = {}, h = { name: d.element, attributes: m, classes: m["class"] ? m["class"].split(/\s+/) : [], styles: h, children: [] };
        ...
        return {
            load: function(b, c, e, g) {
                ...
                var l = b.length,
                    q = [],
                    v = [],
                    f = function(a) { c && (k ? c.call(e, a) : c.call(e, q, v)) };
                if (0 === l) f(!0);
                else {
                    var y = function(a, b) {
                            (b ? q : v).push(a);
                            ...
                            if (a[b]) y(b, !0);
                                ...
                                if (!(1 < e.length)) {
                                    ...
                                    c && (CKEDITOR.env.ie && 8 >= CKEDITOR.env.version ? f.$.onreadystatechange = function() {
                                        if ("loaded" == f.$.readyState || "complete" == f.$.readyState) f.$.onreadystatechange = null, A(b, !0) } : (f.$.onload = function() { setTimeout(function() { A(b, !0) }, 0) }, f.$.onerror = function() { A(b, !1) }));
    ...
    (function() {
        ...
        function d() { do var a = "editor" + ++r; while (CKEDITOR.instances[a]);
            return a }
        ...
        function q(a) { CKEDITOR.skin.loadPart("editor", function() { v(a) }) }
        ...
        function y(a) {
            ...
            CKEDITOR.plugins.load(c.split(","), function(c) {
                ...
                for (var f in c) {
                    ...
                    if (l && (q = l.match(p)))
                        for (; l = q.pop();) CKEDITOR.error("editor-plugin-required", { plugin: l.replace(",", ""), requiredBy: f });
                ...
                for (var c, e, g = 0, k; c = this._.htmlPartsRegex.exec(b);) {
                    ...
                    if (k) k.push(c[0]);
                        ...
                        if (e = e.toLowerCase(), !/="/.test(e)) {
                            ...
                            this.onTagOpen(e, l, c);!k && CKEDITOR.dtd.$cdata[e] && (k = []) } } else if (e = c[2]) this.onComment(e)
                }
                ...
                D.onTagOpen = function(e, m, f, g) {
                    ...
                    if (a(m)) w.push(m);
                        ...
                        if ("pre" == e) h = !0;
                            ...
                            if ("br" == e && h) { u.add(new CKEDITOR.htmlParser.text("\n"));
                                return } "textarea" == e && (t = !0) }
                        if ("br" == e) H.push(m);
                        else {
    ...
    (function() {
            ...
            return a.replace(F,
                function(a, b, c) {
                    return "\x3c" + b + c.replace(B, function(a, b) {
                        return E.test(b) && -1 == c.indexOf("data-cke-saved-" + b) ? " data-cke-saved-" + a + " data-cke-" + CKEDITOR.rnd + "-" + a : a }) + "\x3e" })
        }

        function f(a, b) {
            return a.replace(b, function(a, b, c) { 0 === a.indexOf("\x3ctextarea") && (a = b + r(c).replace(/</g, "\x26lt;").replace(/>/g, "\x26gt;") + "\x3c/textarea\x3e");
        ...
        function n(a, b) {
            ...
            for (var m = 0; m < d.length; m++) a = a.replace(d[m], function(a) { a = a.replace(e, function(a, b, d) {
                    return c[d] });
        ...
        CKEDITOR.editor.prototype.setMode = function(a, b) {
            ...
            if (a != d.mode && k && k[a]) {
                ...
                if (d.mode) {
                    ...
                    d._.previousModeData = q = d.getData(1); "source" == d.mode && k == q && (d.fire("lockSnapshot", { forceUpdate: !0 }), v = 1);
            ...
            proto: {
                ...
                insertElement: function(a, b) {
                    ...
                    this.insertElementIntoRange(a, b) && (b.moveToPosition(a, CKEDITOR.POSITION_AFTER_END), f && ((f = a.getNext(function(a) {
                        return c(a) && !r(a) })) && f.type == CKEDITOR.NODE_ELEMENT && f.is(CKEDITOR.dtd.$block) ? f.getDtd()["#"] ? b.moveToElementEditStart(f) : b.moveToElementEditEnd(a) : f || e == CKEDITOR.ENTER_BR || (f = b.fixBlock(!0,
                    ...
                    if (!this.is("textarea")) {
                        ...
                        CKEDITOR.env.gecko && this.attachListener(this, "mouseup", function(b) {
                            if (2 == b.data.$.button && (b = b.data.getTarget(), !b.getOuterHtml().replace(D, ""))) {
                                ...
                                c.select(!0) } });
                        CKEDITOR.env.webkit && (this.attachListener(this, "click", function(a) { a.data.getTarget().is("input", "select") && a.data.preventDefault() }), this.attachListener(this, "mouseup",
        ...
        n = function() {
            ...
            function b(c, d) {
                ...
                for (var k = B[k.getName()], x = 0, l = c.getChildren(), F = l.count(), z = -1, n = -1, q = 0, v = e.contains(B.$list); x < F; ++x) e = l.getItem(x), a(e) ? (m = e.getName(), v && m in CKEDITOR.dtd.$list ? g = g.concat(b(e, d)) : (p = !!k[m], "br" != m || !e.data("cke-eol") || x && x != F - 1 || (q = (f = x ? g[x - 1].node : l.getItem(x + 1)) && (!a(f) || !f.is("br")), f = f && a(f) && B.$block[f.getName()]), -1 != z || p || (z = x), p || (n = x), g.push({
                    ...
                    name: m,
                    allowed: p
                }), f = q = 0)) : g.push({ isElement: 0, node: e, allowed: 1 }); - 1 < z && (g[z].firstNotAllowed = 1); - 1 < n && (g[n].lastNotAllowed = 1);
                return g
            }
            ...
            return function(n, E, C, I) {
                ...
                if (!I.checkReadOnly()) {
                    ...
                    if (L = C) {
                        L = n.range;
                        if ("text" == n.type && n.inlineStylesRoot) { r = n.inlineStylesPeak;
                        ...
                        if ((A = L.startPath().block) && (1 != A.getChildCount() || !A.getBogus())) a: {
                            var y;
                            if (1 == r.getChildCount() && a(y = r.getFirst()) && y.is(q) && !y.hasAttribute("contenteditable")) { A = y.getElementsByTag("*");
                                L = 0;
                                for (I = A.count(); L < I; L++)
                    ...
                    if (L) {
                        ...
                        for (F(E, y); I < E.length; I++) {
                            ...
                            if (u = J.isLineBreak) {
                                ...
                                var T = void 0,
                                    aa = void 0;
                                J.hasBlockSibling ? u = 1 : (T = u.startContainer.getAscendant(B.$block, 1)) && T.is({ div: 1, p: 1 }) ? (aa = T.getPosition(R), aa == CKEDITOR.POSITION_IDENTICAL ||
                    ...
                    if (!n.dontMoveCaret) {
                        for (M = e(D); M && a(M) && !M.is(B.$empty);) {
                            if (M.isBlockBoundary()) D.moveToPosition(M, CKEDITOR.POSITION_BEFORE_END);
                                ...
                                if (f(M) && M.getHtml().match(/(\s|&nbsp;)$/g)) { S = null;
                                    break }
                                S = D.clone();
    ...
    (function() {
        ...
        CKEDITOR.on("instanceCreated", function(b) {
            ...
            e.on("contentDom", function() {
                function b() { C = new CKEDITOR.dom.selection(e.getSelection());
                    C.lock() }
                ...
                CKEDITOR.env.gecko && g.attachListener(g, "focus", function(a) { a.removeListener();
                    0 !== r && (a = e.getSelection().getNative()) && a.isCollapsed && a.anchorNode == g.$ && (a = e.createRange(), a.moveToElementEditStart(g), a.select()) }, null, null, -2);
                g.attachListener(g,
                    CKEDITOR.env.webkit ? "DOMFocusIn" : "focus",
                    function() { r && CKEDITOR.env.webkit && (r = e._.previousActive && e._.previousActive.equals(f.getActive()));
                        e.unlockSelection(r);
                        r = 0 }, null, null, -1);
                g.attachListener(g, "mousedown", function() { r = 0 });
                if (CKEDITOR.env.ie || q) n ? g.attachListener(g, "beforedeactivate", b, null, null, -1) : g.attachListener(e, "selectionCheck", b, null, null, -1), g.attachListener(g, CKEDITOR.env.webkit ? "DOMFocusOut" : "blur", function() { e.lockSelection(C);
                    r = 1 }, null, null, -1), g.attachListener(g, "mousedown", function() {
                    r =
                        0
                });
                if (CKEDITOR.env.ie && !q) {
                    ...
                    if ("BackCompat" != f.$.compatMode) {
                        if (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) l.on("mousedown", function(a) {
                            ...
                            function c() { l.removeListener("mousemove", b);
        ...
        if (CKEDITOR.env.webkit) CKEDITOR.on("instanceReady", function(a) {
            ...
            b.on("selectionChange", function() {
                ...
                c && (c.getCustomData("ready") ? k(a) : c.setCustomData("ready", 1)) }, null, null, -1);
            b.on("beforeSetMode", function() { k(b.editable()) }, null, null, -1);
            b.on("getSnapshot", function(a) { a.data && (a.data = l(a.data)) }, b, null, 20);
            b.on("toDataFormat",
                function(a) { a.data.dataValue = l(a.data.dataValue) }, null, null, 0)
        });
        ...
        var H = { img: 1, hr: 1, li: 1, table: 1, tr: 1, td: 1, th: 1, embed: 1, object: 1, ol: 1, ul: 1, a: 1, input: 1, form: 1, select: 1, textarea: 1, button: 1, fieldset: 1, thead: 1, tfoot: 1 },
            ...
            t = new RegExp(u + "( )?", "g");
        CKEDITOR.tools.extend(CKEDITOR.dom.selection, { _removeFillingCharSequenceString: l, _createFillingCharSequenceNode: g, FILLING_CHAR_SEQUENCE: u });
        CKEDITOR.dom.selection.prototype = {
                ...
                var a = n ? function() {
                    ...
                    var b = function(b, c) {
                        ...
                        if (-1 == C || C == e.length - 1 && 0 > m) {
                            ...
                            g = g.text.replace(/(\r\n|\r)/g, "\n").length;
                            e = d.childNodes;
                            if (!g) return f = e[e.length - 1], f.nodeType != CKEDITOR.NODE_TEXT ? { container: d, offset: e.length } : { container: f, offset: f.nodeValue.length };
                        ...
                        for (; 0 < g;) try { h = f[0 < m ? "previousSibling" : "nextSibling"], h.nodeType == CKEDITOR.NODE_TEXT && (g -= h.nodeValue.length, n = h), f = h } catch (K) {
                        ...
                        if (l) this.fake(l);
                            ...
                            if (n) {
                                ...
                                for (t = 0; t < a.length; t++) {
                                    if (t < a.length - 1 && (r = a[t], u = a[t + 1], q = r.clone(), q.setStart(r.endContainer, r.endOffset), q.setEnd(u.startContainer, u.startOffset), !q.collapsed && (q.shrink(CKEDITOR.NODE_ELEMENT, !0), l = q.getCommonAncestor(), q = q.getEnclosedNode(), l.isReadOnly() || q && q.isReadOnly()))) { u.setStart(r.startContainer, r.startOffset);
                                        a.splice(t--, 1);
                                        continue }
                                    l = a[t];
                                    ...
                                    try { u.setEnd(l.endContainer.$, l.endOffset) } catch (C) {
            ...
            removeAllRanges: function() {
                if (this.getType() != CKEDITOR.SELECTION_NONE) {
                    var a = this.getNative();
                    try { a && a[n ? "empty" : "removeAllRanges"]() } catch (b) {}
                    this.reset() } }
        }
    })();
    "use strict";
    ...
    (function() {
            ...
            if (c.collapsed) f = H(this, f), c.insertNode(f), c.moveToPosition(f, CKEDITOR.POSITION_BEFORE_END);
                ...
                for (r.getPosition(v) == CKEDITOR.POSITION_FOLLOWING && (r = 0); r;) {
                    ...
                    if (r.equals(v)) r = null, l = !0;
                        ...
                        if (y && r.data("cke-bookmark")) { r = r.getNextSourceNode(!0);
                            continue }
        ...
        var z = { address: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, p: 1, pre: 1, section: 1, header: 1, footer: 1, nav: 1, article: 1, aside: 1, figure: 1, dialog: 1, hgroup: 1, time: 1, meter: 1, menu: 1, command: 1, keygen: 1, output: 1, progress: 1, details: 1, datagrid: 1, datalist: 1 },
            F = { a: 1, blockquote: 1, embed: 1, hr: 1, img: 1, li: 1, object: 1, ol: 1, table: 1, td: 1, tr: 1, th: 1, ul: 1, dl: 1, dt: 1, dd: 1, form: 1, audio: 1, video: 1 },
            B = /\s*(?:;\s*|$)/,
            E = /#\((.+?)\)/g,
        ...
        CKEDITOR.style.prototype = {
            ...
            removeFromRange: function(a) { this.removeFromRange = this.type == CKEDITOR.STYLE_INLINE ? c : this.type == CKEDITOR.STYLE_BLOCK ? q : this.type == CKEDITOR.STYLE_OBJECT ? k : null;
        ...
        CKEDITOR.style.getStyleText = function(a) {
            ...
            for (var e in b) {
                var f = b[e],
                    g = (e + ":" + f).replace(B, ";"); "inherit" == f ? d += g : c += g }
            ...
            do
                if (q.type == CKEDITOR.NODE_ELEMENT) {
                    ...
                    if (!k && (v = q.getName(),
                        ...
                        if (v = !g && "div" == v) { a: { v = q.getChildren();
                                for (var f = 0, y = v.count(); f < y; f++) {
                                    var A = v.getItem(f);
                                    if (A.type == CKEDITOR.NODE_ELEMENT && CKEDITOR.dtd.$block[A.getName()]) { v = !0;
                                        break a } }
                                v = !1 }
                            v = !v }
                        v ? g = q : k = q }
        ...
        CKEDITOR.plugins.clipboard.dataTransfer.prototype = {
            ...
            setData: function(b, a) {
                ...
                if (CKEDITOR.plugins.clipboard.isCustomDataTypesSupported ||
                    "URL" == b || "Text" == b) { "Text" == p && "Text" == b && (this.id = a);
            ...
            cacheData: function() {
                ...
                if (this.$) {
                    ...
                    if (CKEDITOR.plugins.clipboard.isCustomDataTypesSupported) {
                        if (this.$.types)
                            for (c = 0; c < this.$.types.length; c++) b(this.$.types[c]) } else b("Text"),
                        b("URL");
