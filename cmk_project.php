...
$sub_project = array();
   $sql = "select * from project where id not in (65,80,82,84,104,105,70,71,72,75,88,135,75,87,97,98,101,102,103,106,108,88,124,153,160,161,175,182,165,304,184,355,379,381,384,387,388,389,391,394,395,396,399,407,411,313,315,316,319,320,322,324,327,329,331,335,337,338,340,342,351,370,195,199,202,203,206,209,256,376,402) and deleted_at is null order by updated_at desc";
